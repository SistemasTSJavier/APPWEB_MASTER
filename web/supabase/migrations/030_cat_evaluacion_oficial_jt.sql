-- Oficial operaciones: cada jefe de turno califica por separado (calificado_por = N.º JT).
-- Ejecutar en Supabase SQL Editor si cat_evaluacion no tiene submodulo / calificado_por
-- o si al guardar aparece: column "calificado_por" does not exist.
...
comment on column public.cat_evaluacion.calificado_por is
  'Operaciones-jefe_turno: N.º del oficial evaluador. Operaciones-oficial: N.º del JT evaluador. Vacío en RH, enfoque y registros legacy de un solo evaluador.';
